"""
Django settings for contentapi project.
...
ALLOWED_HOSTS = ["localhost", "127.0.0.1", "app.hackathon-20-backend.orb.local"]
...
WSGI_APPLICATION = "contentapi.wsgi.application"
